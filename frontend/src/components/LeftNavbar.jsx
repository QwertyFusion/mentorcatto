      ...
      `}>
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6">
            ...
            <div className="flex gap-2 h-[55px]">
              ...
              <button className="flex items-center justify-center flex-grow p-2 border-2 bg-accent-3 border-tertiary drop-shadow-custom hover:bg-red-900 transition duration-200" onClick={handleLogout}>
                <img
