      ...
      >
        ...
        <nav className="px-4 space-y-3">
          ...
          >
            <IconStore
              ...
              className="w-5 h-5"
              color={`${
                location.pathname === "/dashboard" ? "primary" : "white"
              }`}
            />
          ...
          >
            <IconStore
              ...
              className="w-6 h-6"
              color={`${
                location.pathname === "/courses" ? "primary" : "white"
              }`}
            />
          ...
          >
            <IconStore
              ...
              className="w-6 h-6"
              color={`${
                location.pathname === "/achievements" ? "primary" : "white"
              }`}
            />
          ...
          >
            <IconStore
              ...
              className="w-6 h-6"
              color={`${
                location.pathname === "/assessments" ? "primary" : "white"
              }`}
            />
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6">
          ...
          <div className="flex gap-2 h-[55px]">
            <Link to="/settings">
              ...
              >
                <IconStore
                  ...
                  className="w-6 h-6"
                  color={`${
                    location.pathname === "/settings" ? "primary" : "white"
                  }`}
                />
              </motion.button>
            </Link>
            ...
            >
              <IconStore name="logout" className="w-6 h-6 mr-2" color="white" />
