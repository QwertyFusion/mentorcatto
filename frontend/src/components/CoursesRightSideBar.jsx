                                ...
                                <AccordionContent>
                                    <ul className="pl-5">
                                        ...
                                        <motion.button
                                            ...
                                            className={`mt-4 mb-2 w-full cursor-pointer text-white hover:text-accent-5 transition-all ease-in-out duration-200 flex items-center ${
                                        ...
                                        >
                                            {!assessmentCompleted ? (
                                                ...
                                                <Cat className="h-4.5 w-4.5 me-3 drop-shadow-custom text-black fill-accent-5 animate-bounce" />
                                            )}
                                            <span className="">
                                                {assessmentCompleted
