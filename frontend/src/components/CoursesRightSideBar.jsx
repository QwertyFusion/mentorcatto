...
import { Flame, Loader2, OctagonAlert } from "lucide-react";
...
const CoursesRightSideBar = ({ onLessonSelect, refreshSidebar }) => {
    ...
    const isAssessmentCompleted = (moduleId) => {
        ...
        console.log(
            `Checking assessment completion for ${moduleId}:`,
            completed
        );
        return completed;
    };
            ...
            <div className="bg-accent-1 px-3 pb-3 h-full overflow-auto">
                <Accordion type="single" collapsible>
                    {modules.map((module, index) => {
                        ...
                        const assessmentCompleted = isAssessmentCompleted(
                            module._id
                        );
                                ...
                                <AccordionContent>
                                    <ul className="pl-5">
                                        ...
                                        <motion.button
                                            ...
                                            className={`mt-4 mb-2 w-full cursor-pointer text-white hover:text-orange-400 transition-all ease-in-out duration-200 flex items-center ${
                                        ...
                                        >
                                            {!assessmentCompleted ? (
                                                <div className="h-4.5 w-4.5 rounded-full border-2 border-white me-3 drop-shadow-custom flex items-center justify-center"></div>
                                            ) : (
                                                <Flame className="h-4.5 w-4.5 me-3 drop-shadow-custom text-orange-400 fill-yellow-400 animate-pulse" />
                                            )}
                                            <span className="">
                                                {assessmentCompleted
                                            ...
                                            {!isCompleted &&
                                                !assessmentCompleted && (
                                                    <span className="ml-1 text-xs text-accent-5">
