    ...
    return (
        ...
        >
            <div className="flex items-center mb-8">
                <button
                    onClick={onClose}
                    className="text-white hover:bg-accent-1 hover:drop-shadow-custom p-2 cursor-pointer rounded-seven hover:text-primary transition-colors duration-200 mr-4"
                >
