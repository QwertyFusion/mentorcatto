const IconStore = ({ className, color, name }) => {
    ...
    const renderIcon = () => {
        ...
        case "chat": // Change this svg to a better one with path
            return (
                <img
        ...
        case "courses": // Change this svg to a better one with path
            return (
                <img
                    className={`top-0 left-0 !relative w-6 h-6`}
                    alt="Courses"
        ...
        case "achievements": // Change this svg to a better one with path
            return (
                <img
                    className='top-0 left-0 !relative w-6 h-6'
                    alt="Achievements"
        ...
        case "exam": // Change this svg to a better one with path
            return (
                <img
                    className={`top-0 left-0 !relative w-6 h-6`}
                    alt="Assessments"
        ...
        case "settings": 
            return (
                <svg className={className} xmlns="http://www.w3.org/2000/svg" fill={fillColor} version="1.1" viewBox="0 0 54 54" stroke={fillColor} stroke-width="2.7">
        ...
        case "logout": // Change this svg to a better one with path
            return (
                <img
        ...
        case "send": // Change this svg to a better one with path
            return (
                <img className={className} alt="Send button" src="sent.svg" />
            );
